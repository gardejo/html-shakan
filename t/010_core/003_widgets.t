...
<ul>
<li><label><input name="foo" type="radio" value="a" />1</label></li>
<li><label><input name="foo" type="radio" value="b" />2</label></li>
<li><label><input name="foo" type="radio" value="c" />3</label></li>
</ul>
...
